$(document).ready(function ($) {
  function dropdownMenu(element) {
    ...
    fetch("https://jsonblob.com/api/jsonBlob/6766327f-607d-11e9-95ef-9bcb815ba4a4").then(function (response) {
    ...
    var appendData = function appendData(myJsonData) {
      ...
      _this.mainNavigationItems = _this.mainNavigation.find(".has-dropdown");
      _this.dropdownList = _this.element.find(".dropdown-list");
      _this.dropdownWrappers = _this.dropdownList.find(".dropdown");
      _this.dropdownItems = _this.dropdownList.find(".content");
      _this.dropdownBg = _this.dropdownList.find(".bg-layer");
      _this.mq = _this.checkMq();
